...
ActiveRecord::Schema[8.0].define(version: 2025_08_29_160731) do
  ...
  create_table "spree_policies", force: :cascade do |t|
    ...
    t.string "slug", null: false
    t.string "name", null: false
    t.boolean "show_in_checkout_footer", default: true, null: false
    t.integer "position", default: 0, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["store_id", "position"], name: "index_spree_policies_on_store_id_and_position"
    t.index ["store_id", "show_in_checkout_footer"], name: "index_spree_policies_on_store_id_and_show_in_checkout_footer"
    t.index ["store_id", "slug"], name: "index_spree_policies_on_store_id_and_slug", unique: true
    t.index ["store_id"], name: "index_spree_policies_on_store_id"
  end
